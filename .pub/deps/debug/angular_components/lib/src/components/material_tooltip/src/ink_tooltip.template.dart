...
List<StaticNodeDebugInfo> nodeDebugInfos_MaterialInkTooltipComponentHost0 = [
  new StaticNodeDebugInfo([import27.TooltipController, import5.MaterialInkTooltipComponent], import5.MaterialInkTooltipComponent, <String, dynamic>{})
];
