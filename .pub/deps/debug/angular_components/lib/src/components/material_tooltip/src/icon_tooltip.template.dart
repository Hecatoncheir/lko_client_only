...
class ViewMaterialIconTooltipComponent0 extends DebugAppView<import9.MaterialIconTooltipComponent> {
  ...
  ComponentRef build() {
    ...
    _ClickableTooltipTargetDirective_1_6 = new import2.ClickableTooltipTargetDirective(parentView.injectorGet(import21.DomPopupSourceFactory, viewData.parentIndex), _appEl_1, new ElementRef(_el_1), ref);
    _GlyphComponent_1_7 = new import3.GlyphComponent(_el_1);
    _KeyboardOnlyFocusIndicatorDirective_1_8 = new import4.KeyboardOnlyFocusIndicatorDirective(_el_1, parentView.injectorGet(import23.DomService, viewData.parentIndex));
    ...
    addShimC(_el_4);
    _TooltipController_4_4 = import24.createTooltipController(parentView.injectorGet(import5.TooltipController, viewData.parentIndex, null), parentView.injectorGet(import25.Disposer, viewData.parentIndex, null));
...
List<StaticNodeDebugInfo> nodeDebugInfos_MaterialIconTooltipComponentHost0 = [
  new StaticNodeDebugInfo([import26.AcxDarkTheme, import9.MaterialIconTooltipComponent, import7.DeferredContentAware], import9.MaterialIconTooltipComponent, <String, dynamic>{})
];

class _ViewMaterialIconTooltipComponentHost0 extends DebugAppView<dynamic> {
  ViewMaterialIconTooltipComponent0 _compView_0;
  import26.AcxDarkTheme _AcxDarkTheme_0_4;
  ...
  ComponentRef build() {
    ...
    dbgIdx(rootEl, 0);
    _AcxDarkTheme_0_4 = new import26.AcxDarkTheme(this.injectorGet(const OpaqueToken('acxDarkTheme'), viewData.parentIndex, null));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import26.AcxDarkTheme) && (0 == nodeIndex))) {
