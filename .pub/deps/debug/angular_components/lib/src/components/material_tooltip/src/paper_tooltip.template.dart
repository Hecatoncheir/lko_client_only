...
import '../../../css/acux/zindexer.dart' as import24;
import '../../../laminate/popup/src/popup_size_provider.dart' as import25;
import 'package:angular/src/core/linker/element_ref.dart';
import 'tooltip_controller.dart' as import27;
import '../module.dart' as import28;
...
class _ViewMaterialPaperTooltipComponent1 extends DebugAppView<import5.MaterialPaperTooltipComponent> {
  ...
  ComponentRef build() {
    ...
    _MaterialPopupComponent_0_6 = new import15.MaterialPopupComponent(parentView.injectorGet(import21.DomService, viewData.parentIndex), parentView.injectorGet(import18.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import15.MaterialPopupComponent, viewData.parentIndex, null), 'tooltip', parentView.injectorGet(import22.NgZone, viewData.parentIndex), parentView.injectorGet(import23.OverlayService, viewData.parentIndex), parentView.injectorGet(import24.ZIndexer, viewData.parentIndex), parentView.injectorGet(const OpaqueToken('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const OpaqueToken('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import25.PopupSizeProvider, viewData.parentIndex, null), _compView_0.ref, _appEl_0, new ElementRef(_el_0));
...
List<StaticNodeDebugInfo> nodeDebugInfos_MaterialPaperTooltipComponentHost0 = [
  new StaticNodeDebugInfo([import27.TooltipController, import5.MaterialPaperTooltipComponent, import27.Tooltip, import16.DeferredContentAware], import5.MaterialPaperTooltipComponent, <String, dynamic>{})
];
...
class _ViewMaterialPaperTooltipComponentHost0 extends DebugAppView<dynamic> {
  ...
  ComponentRef build() {
    ...
    dbgIdx(rootEl, 0);
    _TooltipController_0_4 = import28.createTooltipController(this.injectorGet(import27.TooltipController, viewData.parentIndex, null), this.injectorGet(import29.Disposer, viewData.parentIndex, null));
