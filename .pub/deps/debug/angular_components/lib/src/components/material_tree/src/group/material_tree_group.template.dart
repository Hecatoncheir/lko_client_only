...
class _ViewMaterialTreeGroupComponent8 extends DebugAppView<import5.MaterialTreeGroupComponent> {
  ...
  void detectChangesInternal() {
    ...
    if (import12.checkBinding(_expr_0, currVal_0)) {
      _MaterialTreeGroupComponent_0_4.expandAll = currVal_0;
      _expr_0 = currVal_0;
    }
    dbg(0, 73, 12);
    final currVal_1 = locals['\$implicit'];
    if (import12.checkBinding(_expr_1, currVal_1)) {
      _MaterialTreeGroupComponent_0_4.group = currVal_1;
      _expr_1 = currVal_1;
    }
    dbg(0, 74, 12);
    final currVal_2 = (_ctx.level + 1);
    if (import12.checkBinding(_expr_2, currVal_2)) {
      _MaterialTreeGroupComponent_0_4.level = currVal_2;
      _expr_2 = currVal_2;
    }
    dbg(0, 75, 12);
    final currVal_3 = _ctx.showCheckbox(parentView.locals['\$implicit']);
    if (import12.checkBinding(_expr_3, currVal_3)) {
      _MaterialTreeGroupComponent_0_4.parentHasCheckbox = currVal_3;
      _expr_3 = currVal_3;
    }
    _compView_0.detectHostChanges(firstCheck);
    _compView_0.detectChanges();
