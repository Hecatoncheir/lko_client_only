...
import '../../content/deferred_content.template.dart' as _ref6;
import '../../focus/keyboard_only_focus_indicator.template.dart' as _ref7;
import '../../glyph/glyph.template.dart' as _ref8;
import '../../material_popup/material_popup.template.dart' as _ref9;
import '../../mixins/material_dropdown_base.template.dart' as _ref10;
import './material_tree_filter.template.dart' as _ref11;
import './material_tree_root.template.dart' as _ref12;
import 'material_tree_impl.template.dart' as _ref13;
import 'package:angular/angular.template.dart' as _ref14;
...
import '../../../laminate/overlay/src/overlay_service.dart' as import29;
import '../../../css/acux/zindexer.dart' as import30;
...
class ViewMaterialTreeDropdownComponent0 extends DebugAppView<import13.MaterialTreeDropdownComponent> {
  ...
  ComponentRef build() {
    ...
    _PopupSourceDirective_0_5 = new import3.PopupSourceDirective(parentView.injectorGet(import25.DomPopupSourceFactory, viewData.parentIndex), new ElementRef(_el_0), parentView.injectorGet(import27.ReferenceDirective, viewData.parentIndex, null));
    ...
    _MaterialPopupComponent_4_6 = new import6.MaterialPopupComponent(parentView.injectorGet(import24.DomService, viewData.parentIndex), parentView.injectorGet(import9.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import6.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import28.NgZone, viewData.parentIndex), parentView.injectorGet(import29.OverlayService, viewData.parentIndex), parentView.injectorGet(import30.ZIndexer, viewData.parentIndex), parentView.injectorGet(const OpaqueToken('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const OpaqueToken('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import31.PopupSizeProvider, viewData.parentIndex, null), _compView_4.ref, _appEl_4, new ElementRef(_el_4));
...
class _ViewMaterialTreeDropdownComponent5 extends DebugAppView<import13.MaterialTreeDropdownComponent> {
  ...
  void detectChangesInternal() {
    ...
    if (import22.checkBinding(_expr_0, currVal_0)) {
      _MaterialTreeComponent_0_4.componentRenderer = currVal_0;
      _expr_0 = currVal_0;
    }
    dbg(0, 51, 4);
    final currVal_1 = _ctx.itemRenderer;
    if (import22.checkBinding(_expr_1, currVal_1)) {
      _MaterialTreeComponent_0_4.itemRenderer = currVal_1;
      _expr_1 = currVal_1;
    }
    dbg(0, 52, 4);
    final currVal_2 = _ctx.options;
    if (import22.checkBinding(_expr_2, currVal_2)) {
      _MaterialTreeComponent_0_4.options = currVal_2;
      _expr_2 = currVal_2;
    }
    dbg(0, 53, 4);
    final currVal_3 = _ctx.selection;
    if (import22.checkBinding(_expr_3, currVal_3)) {
      _MaterialTreeComponent_0_4.selection = currVal_3;
      _expr_3 = currVal_3;
    }
    dbg(0, 50, 4);
    final currVal_4 = _ctx.expandAll;
    if (import22.checkBinding(_expr_4, currVal_4)) {
      _MaterialTreeComponent_0_4.expandAll = currVal_4;
      _expr_4 = currVal_4;
    }
...
List<StaticNodeDebugInfo> nodeDebugInfos_MaterialTreeDropdownComponentHost0 = [
  new StaticNodeDebugInfo([import13.MaterialTreeDropdownComponent, import36.MaterialTreeRoot], import13.MaterialTreeDropdownComponent, <String, dynamic>{})
];
...
class _ViewMaterialTreeDropdownComponentHost0 extends DebugAppView<dynamic> {
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if (((identical(token, import13.MaterialTreeDropdownComponent) || identical(token, import36.MaterialTreeRoot)) && (0 == nodeIndex))) {
