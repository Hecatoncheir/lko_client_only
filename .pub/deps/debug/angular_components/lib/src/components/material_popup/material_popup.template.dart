...
import '../../laminate/enums/alignment.template.dart' as _ref1;
import '../../laminate/enums/visibility.template.dart' as _ref2;
import '../../laminate/overlay/module.template.dart' as _ref3;
import '../../laminate/overlay/overlay.template.dart' as _ref4;
...
import '../../model/action/async_action.template.dart' as _ref8;
import '../../model/ui/toggle.template.dart' as _ref9;
import '../../utils/browser/dom_service/dom_service.template.dart' as _ref10;
import '../../utils/disposer/disposer.template.dart' as _ref11;
import '../../utils/id_generator/id_generator.template.dart' as _ref12;
import '../content/deferred_content_aware.template.dart' as _ref13;
import '../mixins/material_dropdown_base.template.dart' as _ref14;
import 'package:angular/angular.template.dart' as _ref15;
...
import '../../laminate/overlay/src/overlay_service.dart' as import20;
import '../../css/acux/zindexer.dart' as import21;
import '../../laminate/popup/src/popup_size_provider.dart' as import22;
...
class _ViewMaterialPopupComponentHost0 extends DebugAppView<dynamic> {
  ...
  ComponentRef build() {
    ...
    _MaterialPopupComponent_0_6 = new import4.MaterialPopupComponent(this.injectorGet(import18.DomService, viewData.parentIndex), this.injectorGet(import16.PopupHierarchy, viewData.parentIndex, null), this.injectorGet(import4.MaterialPopupComponent, viewData.parentIndex, null), null, this.injectorGet(import19.NgZone, viewData.parentIndex), this.injectorGet(import20.OverlayService, viewData.parentIndex), this.injectorGet(import21.ZIndexer, viewData.parentIndex), this.injectorGet(const OpaqueToken('defaultPopupPositions'), viewData.parentIndex), this.injectorGet(const OpaqueToken('overlayRepositionLoop'), viewData.parentIndex), this.injectorGet(import22.PopupSizeProvider, viewData.parentIndex, null), _compView_0.ref, _appEl_0, new ElementRef(rootEl));
...
void initReflector() {
  ...
  _ngRef.registerFactory(
    MaterialPopupComponent,
    (DomService p0, PopupHierarchy p1, MaterialPopupComponent p2, String p3, NgZone p4, OverlayService p5, ZIndexer p6, List p7, bool p8, PopupSizeProvider p9, ChangeDetectorRef p10, ViewContainerRef p11, ElementRef p12) => new MaterialPopupComponent(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12),
  );
  _ngRef.registerDependencies(
    MaterialPopupComponent,
    const [
