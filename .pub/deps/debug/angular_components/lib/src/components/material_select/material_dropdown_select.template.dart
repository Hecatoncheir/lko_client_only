...
import '../../css/acux/zindexer.dart' as import29;
import '../../laminate/popup/src/popup_size_provider.dart' as import30;
import '../material_list/material_list.dart' as import31;
...
import '../focus/keyboard_only_focus_indicator.dart' as import35;
import 'material_select_dropdown_item.dart' as import36;
import '../../model/selection/selection_container.dart' as import37;
import '../../model/ui/has_renderer.dart' as import38;
import 'material_select_dropdown_item.template.dart' as import39;
...
class ViewMaterialDropdownSelectComponent0 extends DebugAppView<import12.MaterialDropdownSelectComponent> {
  ...
  ComponentRef build() {
    ...
    _PopupSourceDirective_1_5 = new import3.PopupSourceDirective(parentView.injectorGet(import23.DomPopupSourceFactory, viewData.parentIndex), new ElementRef(_el_1), parentView.injectorGet(import25.ReferenceDirective, viewData.parentIndex, null));
    ...
    _MaterialPopupComponent_5_6 = new import4.MaterialPopupComponent(parentView.injectorGet(import26.DomService, viewData.parentIndex), parentView.injectorGet(import7.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import4.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import27.NgZone, viewData.parentIndex), parentView.injectorGet(import28.OverlayService, viewData.parentIndex), parentView.injectorGet(import29.ZIndexer, viewData.parentIndex), parentView.injectorGet(const OpaqueToken('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const OpaqueToken('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import30.PopupSizeProvider, viewData.parentIndex, null), _compView_5.ref, _appEl_5, new ElementRef(_el_5));
...
List<StaticNodeDebugInfo> nodeDebugInfos_MaterialDropdownSelectComponent1 = [
  new StaticNodeDebugInfo([import31.MaterialListComponent], import31.MaterialListComponent, <String, dynamic>{}),
  null,
  null,
...
class _ViewMaterialDropdownSelectComponent1 extends DebugAppView<import12.MaterialDropdownSelectComponent> {
  ...
  import31.MaterialListComponent _MaterialListComponent_0_4;
  ...
  @override
  ComponentRef build() {
    _compView_0 = new import33.ViewMaterialListComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    dbgElm(this, _el_0, 0, 38, 2);
    _el_0.className = 'options-list';
    createAttr(_el_0, 'tabIndex', '-1');
    addShimC(_el_0);
    _MaterialListComponent_0_4 = new import31.MaterialListComponent();
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import31.MaterialListComponent) && ((0 <= nodeIndex) && (nodeIndex <= 4)))) {
...
List<StaticNodeDebugInfo> nodeDebugInfos_MaterialDropdownSelectComponent2 = [
  ...
  new StaticNodeDebugInfo([TemplateRef, NgIf], null, <String, dynamic>{}),
  null,
  new StaticNodeDebugInfo([TemplateRef, import34.NgFor], null, <String, dynamic>{}),
  null
];
...
class _ViewMaterialDropdownSelectComponent2 extends DebugAppView<import12.MaterialDropdownSelectComponent> {
  ...
  ComponentRef build() {
    ...
    _NgFor_4_7 = new import34.NgFor(_appEl_4, _TemplateRef_4_6);
...
List<StaticNodeDebugInfo> nodeDebugInfos_MaterialDropdownSelectComponent3 = [
  new StaticNodeDebugInfo([import35.KeyboardOnlyFocusIndicatorDirective, import36.MaterialSelectDropdownItemComponent, import37.SelectionItem, import38.HasRenderer], import36.MaterialSelectDropdownItemComponent, <String, dynamic>{}),
  null
];

class _ViewMaterialDropdownSelectComponent3 extends DebugAppView<import12.MaterialDropdownSelectComponent> {
  import13.Element _el_0;
  import39.ViewMaterialSelectDropdownItemComponent0 _compView_0;
  import35.KeyboardOnlyFocusIndicatorDirective _KeyboardOnlyFocusIndicatorDirective_0_4;
  import36.MaterialSelectDropdownItemComponent _MaterialSelectDropdownItemComponent_0_5;
  bool _expr_0;
  var _expr_1;
  bool _expr_2;
  var _expr_3;
  ...
  @override
  ComponentRef build() {
    _compView_0 = new import39.ViewMaterialSelectDropdownItemComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    dbgElm(this, _el_0, 0, 49, 6);
    createAttr(_el_0, 'keyboardOnlyFocusIndicator', '');
    addShimC(_el_0);
    _KeyboardOnlyFocusIndicatorDirective_0_4 = new import35.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.injectorGet(import26.DomService, parentView.parentView.parentView.viewData.parentIndex));
    _MaterialSelectDropdownItemComponent_0_5 = new import36.MaterialSelectDropdownItemComponent(_el_0, parentView.parentView.parentView.parentView.injectorGet(import26.DomService, parentView.parentView.parentView.viewData.parentIndex), (parentView.parentView.parentView as ViewMaterialDropdownSelectComponent0)._MaterialPopupComponent_5_6, parentView.parentView.parentView.parentView.injectorGet(import40.ActivationHandler, parentView.parentView.parentView.viewData.parentIndex, null), _compView_0.ref);
    import13.Text _text_1 = new import13.Text('\n      ');
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import35.KeyboardOnlyFocusIndicatorDirective) && ((0 <= nodeIndex) && (nodeIndex <= 1)))) {
      return _KeyboardOnlyFocusIndicatorDirective_0_4;
    }
    if ((((identical(token, import36.MaterialSelectDropdownItemComponent) || identical(token, import37.SelectionItem)) || identical(token, import38.HasRenderer)) && ((0 <= nodeIndex) && (nodeIndex <= 1)))) {
...
class _ViewMaterialDropdownSelectComponent8 extends DebugAppView<import12.MaterialDropdownSelectComponent> {
  ...
  ComponentRef build() {
    ...
    _NgFor_1_7 = new import34.NgFor(_appEl_1, _TemplateRef_1_6);
    import13.Text _text_2 = new import13.Text('\n          ');
...
class _ViewMaterialDropdownSelectComponent9 extends DebugAppView<import12.MaterialDropdownSelectComponent> {
  ...
  ComponentRef build() {
    ...
    createAttr(_el_0, 'keyboardOnlyFocusIndicator', '');
    addShimC(_el_0);
    _KeyboardOnlyFocusIndicatorDirective_0_4 = new import35.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import26.DomService, parentView.parentView.parentView.parentView.parentView.parentView.viewData.parentIndex));
    _MaterialSelectDropdownItemComponent_0_5 = new import36.MaterialSelectDropdownItemComponent(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import26.DomService, parentView.parentView.parentView.parentView.parentView.parentView.viewData.parentIndex), (parentView.parentView.parentView.parentView.parentView.parentView as ViewMaterialDropdownSelectComponent0)._MaterialPopupComponent_5_6, parentView.parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import40.ActivationHandler, parentView.parentView.parentView.parentView.parentView.parentView.viewData.parentIndex, null), _compView_0.ref);
    import13.Text _text_1 = new import13.Text('\n            ');
...
class _ViewMaterialDropdownSelectComponent10 extends DebugAppView<import12.MaterialDropdownSelectComponent> {
  ...
  ComponentRef build() {
    ...
    createAttr(_el_0, 'keyboardOnlyFocusIndicator', '');
    addShimC(_el_0);
    _KeyboardOnlyFocusIndicatorDirective_0_4 = new import35.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import26.DomService, parentView.parentView.parentView.parentView.parentView.viewData.parentIndex));
    _MaterialSelectDropdownItemComponent_0_5 = new import36.MaterialSelectDropdownItemComponent(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import26.DomService, parentView.parentView.parentView.parentView.parentView.viewData.parentIndex), (parentView.parentView.parentView.parentView.parentView as ViewMaterialDropdownSelectComponent0)._MaterialPopupComponent_5_6, parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import40.ActivationHandler, parentView.parentView.parentView.parentView.parentView.viewData.parentIndex, null), _compView_0.ref);
    import13.Text _text_1 = new import13.Text('\n          ');
...
List<StaticNodeDebugInfo> nodeDebugInfos_MaterialDropdownSelectComponentHost0 = [
  new StaticNodeDebugInfo([import12.MaterialDropdownSelectComponent, import5.DropdownHandle, import38.HasRenderer, import6.DeferredContentAware, import37.SelectionContainer, import30.PopupSizeProvider, import40.ActivationHandler], import12.MaterialDropdownSelectComponent, <String, dynamic>{})
];
...
class _ViewMaterialDropdownSelectComponentHost0 extends DebugAppView<dynamic> {
  ...
  ComponentRef build() {
    ...
    dbgIdx(rootEl, 0);
    _MaterialDropdownSelectComponent_0_4 = new import12.MaterialDropdownSelectComponent(this.injectorGet(import44.IdGenerator, viewData.parentIndex, null), this.injectorGet(import30.PopupSizeProvider, viewData.parentIndex, null), this.injectorGet(const OpaqueToken('isRtl'), viewData.parentIndex, null));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((((((identical(token, import12.MaterialDropdownSelectComponent) || identical(token, import5.DropdownHandle)) || identical(token, import38.HasRenderer)) || identical(token, import6.DeferredContentAware)) || identical(token, import37.SelectionContainer)) || identical(token, import30.PopupSizeProvider)) || identical(token, import40.ActivationHandler)) && (0 == nodeIndex))) {
